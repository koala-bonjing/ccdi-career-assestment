...
export const FOUNDATIONAL_QUESTIONS_MAP: Record<string, FoundationalQuestion> =
  {
    ...
    found_prereq_014: {
      ...
      helper:
        "Basic computer vocabulary helps with understanding instructions.",
    },
    found_prereq_015: {
    ...
    found_study_003: {
      ...
      helper:
        "There's no wrong answer - we want to help you build good habits.",
      isSubjective: true,
    },
    found_study_004: {
    ...
    found_problem_005: {
      ...
      correct: "100 items",
      helper:
        "Business and tech programs work with numbers and data like this.",
    },
    found_problem_006: {
      text: "LOGICAL THINKING: All programmers can code. John can code. Therefore:",
      correct: "John might be a programmer",
      helper:
        "Logical reasoning is crucial for programming and system analysis.",
    },
    found_problem_007: {
      ...
      helper:
        "Don't worry if you don't know - this is what you'll learn in IT!",
    },
    found_problem_008: {
