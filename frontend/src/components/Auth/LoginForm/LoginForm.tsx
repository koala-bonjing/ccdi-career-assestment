...
const LoginForm: React.FC<LoginFormProps> = ({
  ...
  const [resetMessage, setResetMessage] = useState<Message>({ type: "", text: "" });
  ...
  const handleForgotPassword = async (e: React.FormEvent): Promise<void> => {
    ...
    try {
      ...
      if (axios.isAxiosError(error)) {
        ...
        setResetMessage({
          type: "error",
          text: "Failed to send reset code",
        });
      }
    } finally {
              ...
              <div className="w-full max-w-md">
                ...
                <div className="bg-gradient-to-r from-[#2B3176] to-[#1C6CB3] p-6 text-center rounded-t-2xl">
                  ...
                  <h2 className="text-xl font-bold text-white mb-1 leading-snug">
                    {showForgotPassword ? "Reset Your Password" : "Welcome Future CCDI'ans!"}
                  </h2>
                        ...
                        <div className="space-y-1">
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              ...
                              className="text-xs text-[#1C6CB3] hover:text-[#2B3176] font-medium transition-colors"
                            >
                              Forgot Password?
                            </button>
                          </div>
